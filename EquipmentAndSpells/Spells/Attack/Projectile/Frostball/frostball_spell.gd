...
@export var spell_name = "Frostball"
@export var spell_description = "Fires a ball of frost"
@export var spell_category = "Attack"
@export var spell_sub_category = "Projectile"
@export var key_combination = ["down", "down", "down", "left", "right"]
@export var mana_cost = 20
@export var damage = 20
@export var damage_type = "frost"
