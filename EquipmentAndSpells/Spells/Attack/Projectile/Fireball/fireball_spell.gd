...
@export var spell_description = "Fires a ball of fire"
@export var spell_category = "Attack"
@export var spell_sub_category = "Projectile"
@export var key_combination = ["up", "up", "up", "left", "right"]
@export var mana_cost = 20
@export var damage = 20
@export var damage_type = "fire"
...
func onImpact(impact_point):
	if impact_point.get_parent().get_node("HealthComponent"):
		impact_point.get_parent().get_node("HealthComponent").takeDamage(damage, damage_type)
