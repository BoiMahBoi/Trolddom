...
@export var spellName = "Shockbolt"
@export var spellDescription = "Fires a bolt of electricity"
@export var spellType = "Attack"
@export var keyCombination = ["left", "left", "right", "left", "right"]
...
func castSpell(modifierSpells, castPosition):
	var spell_node = load("res://EquipmentAndSpells/Spells/AttackSpells/Shockbolt/shockbolt.tscn").instantiate()
