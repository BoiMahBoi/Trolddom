...
@export var spellDescription = "Fires a ball of fire"
@export var spellType = "Attack"
@export var keyCombination = ["up", "up", "up", "left", "right"]
...
func castSpell(modifierSpells, castPosition):
	var spell_node = load("res://EquipmentAndSpells/Spells/AttackSpells/Fireball/fireball.tscn").instantiate()
