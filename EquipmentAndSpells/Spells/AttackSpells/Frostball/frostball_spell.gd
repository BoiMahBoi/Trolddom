...
@export var spellName = "Frostball"
@export var spellDescription = "Fires a ball of frost"
@export var spellType = "Attack"
@export var keyCombination = ["down", "down", "down", "left", "right"]
...
func castSpell(modifierSpells, castPosition):
	var spell_node = load("res://EquipmentAndSpells/Spells/AttackSpells/Frostball/frostball.tscn").instantiate()
