...
@export var spellName = "Cursebolt"
@export var spellDescription = "Fires a bolt of curse"
@export var spellType = "Attack"
@export var keyCombination = ["up", "down", "down", "left", "right"]
...
func castSpell(modifierSpells, castPosition):
	var spell_node = load("res://EquipmentAndSpells/Spells/AttackSpells/Cursebolt/cursebolt.tscn").instantiate()
